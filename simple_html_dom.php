...
function str_get_wrapper_content(
	$str,
	$lowercase = true,
	$forceTagsClosed = true,
	$target_charset = DEFAULT_TARGET_CHARSET,
	...
	$defaultSpanText = DEFAULT_SPAN_TEXT)
{
	...
	return $dom->load_wrapper_content($str, $lowercase, $stripRN);
}
...
class simple_html_dom
{
		...
		$options = 0)
	{
		...
		// make load function chainable
		$this->root = $this->root->find('body',0)->find('#wrapper',0)->find('#content',0);
		return $this;
	}
